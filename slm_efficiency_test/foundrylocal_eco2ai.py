...
if ECO2AI_AVAILABLE:
    try:
        ...
        tracker = eco2ai.Tracker(
            ...
            experiment_description="Foundry Local energy and carbon consumption tracking",
            file_name="foundry_carbon_consumption.csv"
        )
...
alias = "qwen2.5-1.5b-instruct-cuda-gpu"
...
if carbon_tracking_enabled:
    try:
        ...
        print("Carbon data saved to foundry_carbon_consumption.csv")
    except Exception as e:
